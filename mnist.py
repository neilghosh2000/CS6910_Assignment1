...
weights, train_loss, train_accuracy, val_loss, val_accuracy = train(train_x, train_y, test_x, test_y, nn_layers, epochs, eta, batch_size, optimizer, weight_init, alpha)
